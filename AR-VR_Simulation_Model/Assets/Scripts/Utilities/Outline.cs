       ...
       private List<Vector3> SmoothNormals(Mesh mesh)
{
    ...
    {
        // Handle the case where mesh or its properties are null.
        // You might throw an exception, log an error, or take some appropriate action.
        return new List<Vector3>(); // Or return null, depending on your logic.
    }
